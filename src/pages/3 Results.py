...
def main():
    ...
    with fragile(tab_table):
        ...
        with tab_description:
            ...
            col1.image(resource_path('./media/hover_menu.png').read_bytes(),
                       "By hovering on a header you can access the menu of the column")
            col2.image(resource_path('./media/hover_menu_group_by.png').read_bytes(),
                       "You can group the column by its values")
            col3.image(resource_path('./media/hover_menu_filter_by.png').read_bytes(),
                       'You can filter the column and choose which values to show')

            st.image(resource_path('./media/vertical_tabs_aggrid.png').read_bytes(),
            ...
            *"count(query_title)"* column to sort it. It's very useful if you want to quickly find multiple
            ...
            st.image(resource_path('./media/group_by_strain.png').read_bytes(), "Group by strain")
            st.image(resource_path('./media/group_by_strain2.png').read_bytes(),
